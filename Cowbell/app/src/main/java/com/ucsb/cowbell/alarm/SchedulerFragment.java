...
public class SchedulerFragment extends Fragment {
    ...
    /** registers receiver for Activity */
    ...
    /** Creates view by initializing all the components on the main display */
    ...
    public void onViewCreated(final View rootView, Bundle savedInstanceState) {
        ...
        FloatingActionButton fillInTheBlankFab = (FloatingActionButton) rootView.findViewById(R.id.fab_fill_blank_button);
