/*
    Based on DirectBoot N sample with modifications.
 */
...
public class AlarmStorage {
     ...
     */
    public Alarm saveAlarm(int month, int date, int hour, int minute, int game, String name) {
